...
> **状态：已执行完毕，勿按断点续跑指令重做。** 其 P1（脚注治理三项修复）与 P2（校验器正文-注册表来源一致性检查）已于 2026-09-15 落地并记入 `CHANGELOG.md`；本文件仅作历史记录保留。后续工作以仓库根 `CHANGELOG.md` 与 `08_ops/ARCHITECTURE.md` 为准。
